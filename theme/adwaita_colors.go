...
var adwaitaDarkScheme = map[fyne.ThemeColorName]color.Color{
	...
	theme.ColorNameSuccess:           color.RGBA{0x8f, 0xf0, 0xa4, 0xff}, // Adwaita color name @success_color
	theme.ColorNameWarning:           color.RGBA{0xf8, 0xe4, 0x5c, 0xff}, // Adwaita color name @warning_color
}
...
var adwaitaLightScheme = map[fyne.ThemeColorName]color.Color{
	...
	theme.ColorNameSuccess:           color.RGBA{0x26, 0xa2, 0x69, 0xff}, // Adwaita color name @success_color
	theme.ColorNameWarning:           color.RGBA{0xae, 0x7b, 0x03, 0xff}, // Adwaita color name @warning_color
}
